...
public class WeatherActivity extends AppCompatActivity implements Constants {
    ...
    void fillForm(){
        ...
        cityTemperatureView.setText(CityValues.getInstance().getTemperatureByCity(cityName));
    ...
    void getYandexWeather(){
        showYandexWeatherButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String url = CityValues.getInstance().getYandewWeatherUrlByCity(cityName);
    ...
    void getWikiArticle(){
        showWikiButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String url = CityValues.getInstance().getWikiUrlByCity(cityName);
                Uri uri = Uri.parse(url);
                Intent browser = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(browser);
            }
